 ...
 * (drupal/urban-campaign-conqueror or drupal/legacy-project) and contain complete
...
END;
  ...
  protected function createTestProject(string $template): void {
    ...
    // If using the drupal/urban-campaign-conqueror template, we don't expect there
